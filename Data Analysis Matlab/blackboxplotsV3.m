%blackboxplots
%V3, 9/9/24
%works with main code version 3.7, 3.8, 3.9

%changes since last version:
%-corrected bug with "lastmaxt" that caused it to be added too many times
%to adjust for time resets. Plots look better and to accurate time scale
%now. I think relative plots were true last time, but just the time scale
%could be way off. Somehow my old plots were looking good. 

%tested and this code works lovely now. 
