...
TinyGPSPlus gps;
float currentLat;               //present lattitude
float currentLong;              //present longitude
...
byte waypoint = 1;
double d = 100;                 //distance to waypoint. Don't initalize as = 0
...
const float Ki = .0625;    //integral gain
...
bool magerr;                    //variable to tell if something went wrong with reading compass
