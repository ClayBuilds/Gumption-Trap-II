#SDREADFROMARDUINO
#4/19/25
#Written for Gumption Trap II project
#This code copies all the data coming from the internal SD card connected to the main boat microcontroller. It outputs data over USB cable to the microcontroller.

#local backup version 2
#tested with arduino code "SDREADTOPC.v1" (local backup version)
#Tested: 
